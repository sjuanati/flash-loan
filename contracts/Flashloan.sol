...
contract Flashloan is ICallee, DydxFlashloanBase {
    ...
    function callFunction(
        ...
        bytes memory data //using bytes, it's more flexible (we can decode afterwards what we pass)
    ) public {
        ...
        if (arbInfo.direction == Direction.KyberToUniswap) {
            ...
            (uint expectedRate, ) = kyber.getExpectedRate( // Only get the 1st parameter returned
                dai,
